/*Implemente uma função que receba uma árvore rubro-negra. A função deverá retornar a altura negra da árvore.
...
O valor da altura negra da árvore.
