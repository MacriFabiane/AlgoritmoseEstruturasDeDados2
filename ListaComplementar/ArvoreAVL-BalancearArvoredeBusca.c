/*Implemente uma função que transforme uma uma árvore binária de busca possivelmente desbalanceada em AVL. Em seguida, imprima as chaves de cada nó de forma pré-orde.
...
Impressão prefixa da árvore que foi balanceada.
...
NodeAVL* abb_2_avl(Node *tree, NodeAVL *tb){
    int grown=0; //verifica se need balanceamento
